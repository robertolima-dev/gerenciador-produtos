	...
	public function showProducts() {
		...
		foreach($produtos as $prod) {
			if($prod['id_usuario'] == $_SESSION['id']) {
				...
				$html .= '<td class="data-grid-td">';
				$html .= '<span class="data-grid-cell-content">R$ '.$price.'</span>';
				$html .= '</td>';
	...
	public function showDashboard() {
		...
		foreach($produtos as $prod) {
			if($prod['id_usuario'] == $_SESSION['id']) {
				...
				$html .= '<div class="product-price"><span class="special-price">'.$prod['quantity'].' available</span> <span>R$ '.$price.'</span></div>';
				$html .= '</div>';
				$html .= '</li>';
